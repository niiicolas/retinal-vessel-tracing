...
# ==========================================
def evaluate(split):
    """Evaluate Frangi on one split ("val" = combined val set, else a test
    dataset name) through the shared scorer at RL settings (resize 512)."""
