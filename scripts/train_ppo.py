...
from config import (
    IMITATION_WEIGHTS_PATH as IMITATION_WEIGHTS,
)
...
class LazyEnvDataset:
    ...
    def __getitem__(self, idx):
        ...
        # Predicted priors from the frozen UNet — feed the observation
        # channels with non-leaking geometry.
